...
<%
// 데이터베이스 연결 정보
String url = "jdbc:mariadb://ksh-aws-rds.ctiqo8cs0wya.ap-northeast-2.rds.amazonaws.com/cloud_air"; // MariaDB 사용
...
if (loginSuccess) {
    ...
    response.sendRedirect("/?userId=" + inputUsername + "&sessionId=" + sessionId); // 성공 페이지로 리디렉션
} else {
